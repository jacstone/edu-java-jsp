<html>
<head>
<title>Crazy Words - More Words</title>
</head>
<body>
	...
	<form method="get" action="/crazywords/results">
		<input type="hidden" name="noun1"
			value="<%= request.getAttribute("noun1") %>"> <input
			type="hidden" name="noun2"
			value="<%= request.getAttribute("noun2") %>">
